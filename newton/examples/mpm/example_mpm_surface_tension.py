...
from newton.examples.mpm.implicit_mpm_surface import SolverImplicitMPMSurface
from newton.examples.mpm.particle_surface import compute_vertex_normals
...
class Example:
    def __init__(self, viewer, options):
        ...
        SolverImplicitMPMSurface.register_custom_attributes(builder)
        ...
        mpm_options = SolverImplicitMPMSurface.Config()
        ...
        mpm_options.contact_angle_force = options.contact_angle_force

        self.solver = SolverImplicitMPMSurface(self.model, mpm_options)
    ...
    def render(self):
        ...
        surface = self.solver.particle_surface
    ...
    def create_parser():
        ...
        parser.add_argument("--contact-angle-force", type=str, default="angle_mask",
                            choices=["angle_mask", "dual_coeff"],
                            help="Contact angle force mode")
