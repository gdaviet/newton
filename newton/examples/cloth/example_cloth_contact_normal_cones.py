...
class Example:
    def __init__(self, viewer, args):
        ...
        # LOX mixes this soft-side coefficient with the slope's shape material.
        # The lower sheet stays anchored, while the resulting near-critical
        # value lets the free upper sheet drift slowly down the 25-degree slope.
        ...
        self.collision_pipeline = newton.CollisionPipeline(self.model, soft_contact_gap=0.015)
    ...
    def capture(self):
        """Capture the simulation directly from the initial state."""
